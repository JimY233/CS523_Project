...
In the related paper, it discusses the influence of optimizer, scheduler, fine tuning part and we also modify the code to make the experiment on them.
...
One of the main differences of this model is the batch normalization layer  
Batch normalization is used here to speed up the learning process, reduce the internal covariance shift, and prevent gradient vanishing or explosion.  
